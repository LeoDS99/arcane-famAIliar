...
export default function Home() {
  ...
  async function invia() {
   ...
   return (
    <main className="mx-auto flex h-screen max-w-2xl flex-col bg-gray-900 p-4 text-gray-100">
      <h1 className="mb-4 text-2xl font-bold text-purple-300">Arcane famAIliar 🔮</h1>
